...
ADD https://github.com/phpredis/phpredis/archive/4.2.0.tar.gz /tmp/phpredis.tar.gz
...
ADD https://pecl.php.net/get/apcu-5.1.16.tgz /tmp/apcu.tar.gz
...
ADD https://pecl.php.net/get/apcu_bc-1.0.4.tgz /tmp/apcu_bc.tar.gz
...
VOLUME /home/ac_website/www
WORKDIR /home/ac_website/www
