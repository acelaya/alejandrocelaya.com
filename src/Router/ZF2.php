...
use Acelaya\Website\Router\Http\SkippableSegment;
...
/**
 * Copy-pasted from Expressive\ZF2 router (couldn't extend because everything is private instead of protected)
 * This class creates SkippableSegment routes instead of Segment routes
 */
